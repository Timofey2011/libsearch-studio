...
export const makeBook = async file => {
    ...
    if (file.isDirectory) {
        ...
        // LOCAL MODIFICATION (see README.md): PDFs render through the app's
        // own PdfReader; foliate's pdf.js would bundle a second pdfjs build.
        throw new Error('PDFs are handled by the app, not the book reader')
    }
    else {
